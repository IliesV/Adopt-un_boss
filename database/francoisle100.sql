...
INSERT INTO `adopt_un_boss`.`entreprise` (`user_id`, `nom`, `tel`, `adresse`, `logo`, `description`, `salarie`, `site_web`, `date_creation`, `mail`, `password`) VALUES (21, 'nintendo', '0455655443', '6 boulevard de l’Oise\nImmeuble Le Montaigne\n95031 Cergy Pontoise CEDEX', 'https://slack-imgs.com/?c=1&url=https%3A%2F%2F3.bp.blogspot.com%2F-m7Y-MhoOEpY%2FWpae3Hv5jCI%2FAAAAAAAABIc%2FQhGn8Z1XKTgEWmXzQTzSox7ZHJ_Q5BidQCLcBGAs%2Fs1600%2FEl%252Bprofesor%252BLa%252Bcasa%252Bde%252Bpapel.jpg', 'Nintendo est une entreprise multinationale japonaise fondée en 1889 par Fusajiro Yamauchi près de Kyoto au Japon. À ses débuts, la société produisait des cartes à jouer japonaises : les Hanafuda.', 554, 'http://nintendo.fr', '2018-06-19', NULL, NULL);
INSERT INTO `adopt_un_boss`.`entreprise` (`user_id`, `nom`, `tel`, `adresse`, `logo`, `description`, `salarie`, `site_web`, `date_creation`, `mail`, `password`) VALUES (22, 'sony', '0467223344', '92 Avenue de Wagram, 75017 Paris', 'https://slack-imgs.com/?c=1&url=https%3A%2F%2F3.bp.blogspot.com%2F-m7Y-MhoOEpY%2FWpae3Hv5jCI%2FAAAAAAAABIc%2FQhGn8Z1XKTgEWmXzQTzSox7ZHJ_Q5BidQCLcBGAs%2Fs1600%2FEl%252Bprofesor%252BLa%252Bcasa%252Bde%252Bpapel.jpg', 'Sony Corporation, est une société multinationale japonaise basée dans l\'arrondissement de Minato, à Tokyo, Japon.', 8000, 'https://www.sony.fr', '2018-06-19', NULL, NULL);
INSERT INTO `adopt_un_boss`.`entreprise` (`user_id`, `nom`, `tel`, `adresse`, `logo`, `description`, `salarie`, `site_web`, `date_creation`, `mail`, `password`) VALUES (23, 'activison', '0454455567', 'Fraunhoferstraße 7, 85737 Ismaning, Allemagne', 'https://slack-imgs.com/?c=1&url=https%3A%2F%2F3.bp.blogspot.com%2F-m7Y-MhoOEpY%2FWpae3Hv5jCI%2FAAAAAAAABIc%2FQhGn8Z1XKTgEWmXzQTzSox7ZHJ_Q5BidQCLcBGAs%2Fs1600%2FEl%252Bprofesor%252BLa%252Bcasa%252Bde%252Bpapel.jpg', 'Activision, Inc. est une entreprise américaine de développement et d\'édition de jeux vidéo, créée en 1979.', 5430, 'https://www.activisonblizzard.com', '2018-06-19', NULL, NULL);
...
INSERT INTO `adopt_un_boss`.`entreprise` (`user_id`, `nom`, `tel`, `adresse`, `logo`, `description`, `salarie`, `site_web`, `date_creation`, `mail`, `password`) VALUES (30, 'triotech', '0467825693', 'Bâtiment, Le Cathare, A, 345 Avenue de Monsieur Teste, 34070 Montpellier', 'https://slack-imgs.com/?c=1&url=https%3A%2F%2F3.bp.blogspot.com%2F-m7Y-MhoOEpY%2FWpae3Hv5jCI%2FAAAAAAAABIc%2FQhGn8Z1XKTgEWmXzQTzSox7ZHJ_Q5BidQCLcBGAs%2Fs1600%2FEl%252Bprofesor%252BLa%252Bcasa%252Bde%252Bpapel.jpg', 'Designers, développeurs, chefs de projet, conseillers clientèle, Triotech est constitué de talents aux multiples savoir-faire.', 150, 'https://www.triotech.fr', '2018-06-19', NULL, NULL);
...
INSERT INTO `adopt_un_boss`.`chat` (`id`, `recepteur_id`, `emetteur_id`, `contenu`, `date_creation`) VALUES (DEFAULT, 19, 34, NULL, NULL);
INSERT INTO `adopt_un_boss`.`chat` (`id`, `recepteur_id`, `emetteur_id`, `contenu`, `date_creation`) VALUES (DEFAULT, 19, 30, NULL, NULL);
INSERT INTO `adopt_un_boss`.`chat` (`id`, `recepteur_id`, `emetteur_id`, `contenu`, `date_creation`) VALUES (DEFAULT, 19, 20, NULL, NULL);
INSERT INTO `adopt_un_boss`.`chat` (`id`, `recepteur_id`, `emetteur_id`, `contenu`, `date_creation`) VALUES (DEFAULT, 19, 22, NULL, NULL);
INSERT INTO `adopt_un_boss`.`chat` (`id`, `recepteur_id`, `emetteur_id`, `contenu`, `date_creation`) VALUES (DEFAULT, 19, 34, NULL, NULL);
INSERT INTO `adopt_un_boss`.`chat` (`id`, `recepteur_id`, `emetteur_id`, `contenu`, `date_creation`) VALUES (DEFAULT, 19, 30, NULL, NULL);
INSERT INTO `adopt_un_boss`.`chat` (`id`, `recepteur_id`, `emetteur_id`, `contenu`, `date_creation`) VALUES (DEFAULT, 19, 24, NULL, NULL);
...
START TRANSACTION;
USE `adopt_un_boss`;
INSERT INTO `adopt_un_boss`.`candidat_and_entreprise_chat` (`candidat_user_id`, `entreprise_user_id`, `nombre_message`) VALUES (9, 20, 2);
INSERT INTO `adopt_un_boss`.`candidat_and_entreprise_chat` (`candidat_user_id`, `entreprise_user_id`, `nombre_message`) VALUES (9, 22, 2);
INSERT INTO `adopt_un_boss`.`candidat_and_entreprise_chat` (`candidat_user_id`, `entreprise_user_id`, `nombre_message`) VALUES (9, 30, 2);
INSERT INTO `adopt_un_boss`.`candidat_and_entreprise_chat` (`candidat_user_id`, `entreprise_user_id`, `nombre_message`) VALUES (9, 34, 2);
