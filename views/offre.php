                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card card--big js-user-matching-container offer offer--full" itemscope="" itemtype="http://schema.org/JobPosting">
                                ...
                                <div class="row">
                                    <?php if(!$bool): ?>
                                    <div class="col-md-12"><div class="text-right"><a class="btn btn-info inverse white-space-normal" href="/like/<?= $offre->getId()?>"><i class="fa fa-heart"></i> Je like !</a></div>
                                    <?php else : ?>
                                    <div class="col-md-12"><div class="text-right"><a class="btn btn-info inverse white-space-normal" href="/unlike/<?= $offre->getId()?>"><i class="fas fa-ban"></i> Cela ne m'intéresse plus</a></div>
                                    <?php endif ?> 
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card" itemscope="" itemtype="http://schema.org/Organization">
                                ...
                                <div class="text-center"><a class="btn btn-info inverse white-space-normal" href="/profil/<?= $entreprise->getUser_id() ?>">Découvrir <?= $entreprise->getNom() ?></a></div>
                            </div>
