                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card card--big js-user-matching-container offer offer--full" itemscope="" itemtype="http://schema.org/JobPosting">
                                    ...
                                    <div class="row-height">
                                        <div class="col-sm-10 col-sm-height col-sm-middle">
                                            <h1 itemprop="title" class="offer__title top h1"><?= $offre->getIntitule() ?>
                                                ...
                                                chez
                                                <span itemprop="name"><a class="text-link" href=""><?= $entreprise->getNom() ?></a></span>
                                            </div>
                                            <div class="profile">
                                ...
                                <div class="row">
                                    <div class="col-md-12"><div class="text-right"><a data-target="#sign_up_or_sign_in" data-toggle="modal" data-offer="23883" class="btn btn-info inverse white-space-normal" href="#sign_up_or_sign_in"><i class="fa fa-heart"></i> Je suis intéressé !</a></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="card" itemscope="" itemtype="http://schema.org/Organization">
                                <div class="center-block thumbnail-xl">
                                    <div class="thumbnail thumbnail-xl thumbnail--light">
                                        <img class="img-responsive" src="https://assets.chooseyourboss.com/companies/logos/000/003/225/square/gimmick%20Daveo.jpg?1501163600" alt="Gimmick%20daveo">
                                    </div>
                                </div>
                                ...
                                <div class="text-center"><a class="btn btn-info inverse white-space-normal" href="/companies/daveo-bb40d1a2-d368-4434-981b-4f6ea35d38cf">Découvrir <?= $entreprise->getNom() ?></a></div>
                            </div>
                            ...
                            <div class="similar-offers card">
                                <div><div class="list-item--bordered offer-small p-y-1">
                                        <div itemprop="title" class="offer__title top h4"><a href="/candidates/offers/developpeur-big-data-h-f-daveo">Développeur Big Data - H/F</a>
                                        ...
                                        <div class="profile">
                                            <div class="row skills no-gutter">
                                                <div class="col-md-12">
                                                    <ul class="list-inline" itemprop="skills"><li class="skill">
                                                            <a href="/offres/emploi-big-data">big data</a>
                                                        </li><li class="skill">
                                                            <a href="/offres/emploi-hadoop">hadoop</a>
                                                        </li><li class="skill">
                                                            <a href="/offres/emploi-spark">spark</a>
                                                        </li><li class="skill">
                                                            <a href="/offres/emploi-scala">scala</a>
                                                        </li><li class="skill">
                                                            <a href="/offres/emploi-cassandra">cassandra</a>
                                                        </li></ul>
                                                </div>
                                            </div>
                                            <div class="row others">
                                                <div class="col-md-12">
                                                    <ul class="list-inline">
                                                        <li>
                                                            <i class="fa icon-specialization fa-lg"></i>
                                                            <span class="specialization">Backend</span>
                                                        </li>
                                                        <li itemprop="employmentType">
                                                        ...
                                                        <li itemprop="experienceRequirements">
                                                            <i class="fa fa-lg icon-experienced"></i>
                                                            2 - 6 ans
                                                        </li>
                                                        <li class="locations">
                                                            ...
                                                            <ul class="list-inline">
                                                                <li itemprop="jobLocation">
                                                                    <a href="/offres/emploi-it-montreuil">Paris</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                ...
                                <div class="text-center">
                                    <a class="btn btn-info inverse btn-sm" href="/offres/emploi-bigdata">Voir d'autres offres</a>
                                </div>
                            </div>
                            <?php endforeach; }?>
                            <div class="sign-up-box text-center m-b-1">
                                <div class="p-x-1 p-t-1">
                                    <div><span class="sign-up-box__logo">Choose</span><span class="sign-up-box__logo sign-up-box__logo--inverse">Your</span><span class="sign-up-box__logo">Boss</span></div>
                                    <div class="sign-up-box__match m-b-half">vous matche avec les meilleures offres IT</div>
                                    <a class="btn btn-white btn-sm" data-turbolinks-track="false" href="/candidates/sign_up">Je m'inscris</a>
                                    <a class="btn btn-link--white btn-sm uppercase m-a-0" href="/comment_ca_marche">Comment ça marche</a>
                                </div>
                                <hr class="m-a-0">
                                <div class="p-a-1">
                                    <small>Vous avez déjà un compte ?</small>
                                    <a class="btn btn-link--white btn-sm uppercase m-a-0" rel="nofollow" href="/users/sign_in">Connexion</a>
                                </div>
                            </div>
                        </div>
                    </div>
