...
<!--                        <button class="btn btn-outline-primary followbtn">Like <i class="fas fa-heart" style="color: red"></i></button>-->
                        <button id="like_candidat" class="btn btn-outline-primary followbtn" data-toggle="modal" data-target="#modalLikeCandidat" href="#" role="button">Like<i class="fas fa-heart"></i></button>
                    </ul>
                </div>
            </div>
        </div>
...
<!--                <div class="col-md-12">
    ...
    <div class="modal fade" id="modalLikeCandidat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
